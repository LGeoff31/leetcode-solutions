<p>You are given an integer array <code>nums</code>. In one operation, you can select a subarray and replace it with a single element equal to its <strong>maximum</strong> value.</p>
